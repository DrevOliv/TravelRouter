...
from ..api_models import JellyfinSettingsBody, TailscaleSettingsBody, WifiSettingsBody
...
@router.post("/settings/tailscale/login")
...
@router.post("/settings/tailscale")
