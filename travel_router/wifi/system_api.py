...
from ..command_runner import command_result, demo_command_result, run_command
from ..env import is_demo_mode
from ..settings_store import demo_state, update_demo, update_settings
...
def scan_wifi(interface: str) -> dict:
    ...
    return run_command(
        ["sudo", "nmcli", "-t", "-f", "SSID,SIGNAL,SECURITY", "device", "wifi", "list", "ifname", interface, "--rescan", "yes"]
    )
